...
MENU(mainMenu, "LED settings", doNothing, noEvent, wrapStyle, FIELD(ledColour, "Colour", "", 0, 7, 1, 0, adjustColour, exitEvent, noStyle), FIELD(ledBrightness, "Brightness", "", 0, 7, 1, 0, adjustBrightness, exitEvent, noStyle), EXIT("Hide"));
